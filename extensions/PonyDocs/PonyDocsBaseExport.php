...
EOT;
	...
	/**
	 * Generates an HTML Array which represents the entire manual topics for a given product and version.
	 *
	 * @param $product PonyDocsProduct
	 * @param $manual  PonyDocsProductManual
	 * @param $version PonyDocsProductVersion
	 * @param $articles PonyDocsProductArticles
	 *	
	 * @return HTML Array representation of manual contents
	 */
	public function getManualTopicsHTML($product, $manual, $version, $articles)
	{
		global $wgOut, $wgUser, $wgTitle, $wgParser, $wgRequest;
		global $wgServer, $wgArticlePath, $wgScriptPath, $wgUploadPath, $wgUploadDirectory, $wgScript, $wgStylePath;
